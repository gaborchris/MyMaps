...
class MainActivity : AppCompatActivity() {
    ...
    private fun showAlertDiaglog() {
        ...
        dialog.getButton(DialogInterface.BUTTON_POSITIVE).setOnClickListener{
            ...
            if (title.trim().isEmpty()) {
                Toast.makeText(this, "Map must have non-empty title and", Toast.LENGTH_LONG).show()
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        if (requestCode == REQUEST_CODE && resultCode == Activity.RESULT_OK) {
            ...
            serialzeUserMaps(this, userMaps)

        }
        super.onActivityResult(requestCode, resultCode, data)
    }

    private fun serialzeUserMaps(context: Context, userMaps: List<UserMap>) {
